...
代码来自 https://github.com/pengchujin/v2rayDockeri 升级了caddy 2.0 和 v2ray 4.23.4
...
```
sudo docker run -d --rm --name v2ray -p 443:443 -p 80:80 -v $HOME/.caddy:/root/.caddy woodycc/v2ray_ws:0.0.11 YOURDOMAIN.COM V2RAY_WS 0890b53a-e3d4-4726-bd2b-52574e8588c4 && sleep 3s && sudo docker logs v2ray
```
